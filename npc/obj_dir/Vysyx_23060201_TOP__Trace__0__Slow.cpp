...
VL_ATTR_COLD void Vysyx_23060201_TOP___024root__trace_init_sub__TOP__0(Vysyx_23060201_TOP___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+230,"inst", false,-1, 31,0);
    tracep->declBus(c+231,"pc", false,-1, 31,0);
    tracep->declBus(c+116,"wire_npc", false,-1, 31,0);
    tracep->declBus(c+232,"wire_op", false,-1, 6,0);
    tracep->declBus(c+72,"wire_func3", false,-1, 2,0);
    tracep->declBus(c+233,"wire_rd", false,-1, 4,0);
    tracep->declBus(c+73,"wire_imm", false,-1, 31,0);
    tracep->declBit(c+228,"gpr_clk", false,-1);
    tracep->declBit(c+264,"wire_wen", false,-1);
    tracep->declBus(c+74,"wire_waddr", false,-1, 4,0);
    tracep->declBus(c+117,"wire_wdata", false,-1, 31,0);
    tracep->declBus(c+75,"wire_ren", false,-1, 1,0);
    tracep->declBus(c+234,"wire_raddr1", false,-1, 4,0);
    tracep->declBus(c+235,"wire_raddr2", false,-1, 4,0);
    tracep->declBus(c+118,"wire_rdata1", false,-1, 31,0);
    tracep->declBus(c+119,"wire_rdata2", false,-1, 31,0);
    tracep->pushNamePrefix("ysyx_23060201_EXU ");
    tracep->declBit(c+228,"clk_a", false,-1);
    tracep->declBus(c+231,"pc", false,-1, 31,0);
    tracep->declBus(c+73,"imm", false,-1, 31,0);
    tracep->declBus(c+232,"op", false,-1, 6,0);
    tracep->declBus(c+233,"rd", false,-1, 4,0);
    tracep->declBus(c+72,"func3", false,-1, 2,0);
    tracep->declBus(c+234,"raddr1", false,-1, 4,0);
    tracep->declBus(c+118,"rdata1", false,-1, 31,0);
    tracep->declBus(c+119,"rdata2", false,-1, 31,0);
    tracep->declBit(c+228,"clk_b", false,-1);
    tracep->declBit(c+264,"wen", false,-1);
    tracep->declBus(c+74,"waddr", false,-1, 4,0);
    tracep->declBus(c+117,"wdata", false,-1, 31,0);
    tracep->declBus(c+116,"npc", false,-1, 31,0);
    tracep->declBus(c+236,"snpc", false,-1, 31,0);
    tracep->declBus(c+120,"alu_a", false,-1, 31,0);
    tracep->declBus(c+121,"alu_b", false,-1, 31,0);
    ...
    tracep->declBus(c+232,"key", false,-1, 6,0);
    tracep->declBus(c+267,"default_out", false,-1, 31,0);
    tracep->declArray(c+237,"lut", false,-1, 272,0);
    ...
    for (int i = 0; i < 7; ++i) {
        tracep->declQuad(c+122+i*2,"pair_list", true,(i+0), 38,0);
    }
    for (int i = 0; i < 7; ++i) {
    ...
    tracep->declBus(c+232,"key", false,-1, 6,0);
    tracep->declBus(c+267,"default_out", false,-1, 31,0);
    tracep->declArray(c+145,"lut", false,-1, 116,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+271,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+265,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+266,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+269,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 3; ++i) {
        tracep->declQuad(c+149+i*2,"pair_list", true,(i+0), 38,0);
    }
    for (int i = 0; i < 3; ++i) {
        tracep->declBus(c+8+i*1,"key_list", true,(i+0), 6,0);
    }
    for (int i = 0; i < 3; ++i) {
        tracep->declBus(c+155+i*1,"data_list", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+232,"key", false,-1, 6,0);
    tracep->declBus(c+236,"default_out", false,-1, 31,0);
    tracep->declArray(c+246,"lut", false,-1, 77,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+278,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+265,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+266,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+232,"key", false,-1, 6,0);
    tracep->declBus(c+233,"default_out", false,-1, 4,0);
    tracep->declBus(c+249,"lut", false,-1, 11,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+268,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+265,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+280,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+120,"a", false,-1, 31,0);
    tracep->declBus(c+121,"b", false,-1, 31,0);
    tracep->declBus(c+76,"ctl", false,-1, 3,0);
    tracep->declBus(c+117,"res", false,-1, 31,0);
    tracep->declBus(c+168,"b2", false,-1, 31,0);
    tracep->declBus(c+169,"alu_addsub", false,-1, 31,0);
    tracep->declBus(c+170,"alu_xor", false,-1, 31,0);
    tracep->declBus(c+171,"alu_and", false,-1, 31,0);
    tracep->declBus(c+172,"alu_or", false,-1, 31,0);
    tracep->declBus(c+173,"alu_lrs", false,-1, 31,0);
    ...
    tracep->declArray(c+174,"lut", false,-1, 179,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+280,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+273,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+266,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBit(c+264,"wen", false,-1);
    tracep->declBus(c+234,"raddr1", false,-1, 4,0);
    tracep->declBus(c+235,"raddr2", false,-1, 4,0);
    tracep->declBus(c+74,"waddr", false,-1, 4,0);
    tracep->declBus(c+117,"wdata", false,-1, 31,0);
    tracep->declBus(c+118,"rdata1", false,-1, 31,0);
    tracep->declBus(c+119,"rdata2", false,-1, 31,0);
    ...
    tracep->declBus(c+232,"inst_op", false,-1, 6,0);
    tracep->declBus(c+233,"inst_rd", false,-1, 4,0);
    tracep->declBus(c+72,"inst_func3", false,-1, 2,0);
    tracep->declBus(c+75,"ren", false,-1, 1,0);
    tracep->declBus(c+234,"raddr1", false,-1, 4,0);
    tracep->declBus(c+235,"raddr2", false,-1, 4,0);
    tracep->declBus(c+234,"inst_rs1", false,-1, 4,0);
    tracep->declBus(c+235,"inst_rs2", false,-1, 4,0);
    tracep->declBus(c+84,"imm_I", false,-1, 31,0);
    tracep->declBus(c+250,"imm_S", false,-1, 31,0);
    tracep->declBus(c+251,"imm_B", false,-1, 31,0);
    tracep->declBus(c+252,"imm_U", false,-1, 31,0);
    tracep->declBus(c+85,"imm_J", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060201_TOP___024root__trace_full_sub_0(Vysyx_23060201_TOP___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+85,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_J),32);
    bufp->fullCData(oldp+86,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__func3_aupic__DOT__i0__DOT__lut_out),3);
    bufp->fullBit(oldp+87,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__func3_aupic__DOT__i0__DOT__hit));
    bufp->fullCData(oldp+88,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__gpr_ren__DOT__i0__DOT__lut_out),2);
    bufp->fullBit(oldp+89,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__gpr_ren__DOT__i0__DOT__hit));
    bufp->fullQData(oldp+90,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+92,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullQData(oldp+94,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[2]),39);
    bufp->fullQData(oldp+96,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[3]),39);
    bufp->fullQData(oldp+98,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[4]),39);
    bufp->fullQData(oldp+100,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[5]),39);
    bufp->fullQData(oldp+102,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[6]),39);
    bufp->fullQData(oldp+104,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__pair_list[7]),39);
    bufp->fullIData(oldp+106,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+107,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+108,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+109,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+110,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+111,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+112,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+113,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+114,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+115,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_sel__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+116,(vlSelf->ysyx_23060201_TOP__DOT__wire_npc),32);
    bufp->fullIData(oldp+117,(vlSelf->ysyx_23060201_TOP__DOT__wire_wdata),32);
    bufp->fullIData(oldp+118,(vlSelf->ysyx_23060201_TOP__DOT__wire_rdata1),32);
    bufp->fullIData(oldp+119,(vlSelf->ysyx_23060201_TOP__DOT__wire_rdata2),32);
    bufp->fullIData(oldp+120,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a),32);
    bufp->fullIData(oldp+121,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b),32);
    bufp->fullQData(oldp+122,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+124,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullQData(oldp+126,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[2]),39);
    bufp->fullQData(oldp+128,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[3]),39);
    bufp->fullQData(oldp+130,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[4]),39);
    bufp->fullQData(oldp+132,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[5]),39);
    bufp->fullQData(oldp+134,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__pair_list[6]),39);
    bufp->fullIData(oldp+136,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+137,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+138,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+139,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+140,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+141,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+142,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+143,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+144,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a_sel__DOT__i0__DOT__hit));
    ...
    __Vtemp_h9a2d4471__0[3U] = (0xcc000U | (vlSelf->ysyx_23060201_TOP__DOT__wire_rdata2 
                                            >> 0x12U));
    bufp->fullWData(oldp+145,(__Vtemp_h9a2d4471__0),117);
    bufp->fullQData(oldp+149,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+151,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullQData(oldp+153,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__pair_list[2]),39);
    bufp->fullIData(oldp+155,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+156,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+157,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+158,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+159,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b_sel__DOT__i0__DOT__hit));
    bufp->fullQData(oldp+160,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+162,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullIData(oldp+164,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+165,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+166,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+167,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__npc_sel__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+168,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__b2),32);
    ...
    bufp->fullIData(oldp+171,((vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a 
                               & vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b)),32);
    bufp->fullIData(oldp+172,((vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a 
                               | vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b)),32);
    bufp->fullIData(oldp+173,(((0x1fU >= vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_b)
    ...
    __Vtemp_hc3c426de__0[5U] = ((vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__alu_a 
                                ...
                                >> 0x10U);
    bufp->fullWData(oldp+174,(__Vtemp_hc3c426de__0),180);
    bufp->fullQData(oldp+180,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__pair_list[0]),36);
    bufp->fullQData(oldp+182,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__pair_list[1]),36);
    bufp->fullQData(oldp+184,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__pair_list[2]),36);
    bufp->fullQData(oldp+186,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__pair_list[3]),36);
    bufp->fullQData(oldp+188,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__pair_list[4]),36);
    bufp->fullIData(oldp+190,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+191,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+192,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+193,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+194,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+195,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_EXU__DOT__ysyx_23060201_ALU__DOT__alu__DOT__i0__DOT__lut_out),32);
    bufp->fullIData(oldp+196,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[0]),32);
    bufp->fullIData(oldp+197,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[1]),32);
    bufp->fullIData(oldp+198,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[2]),32);
    bufp->fullIData(oldp+199,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[3]),32);
    bufp->fullIData(oldp+200,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[4]),32);
    bufp->fullIData(oldp+201,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[5]),32);
    bufp->fullIData(oldp+202,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[6]),32);
    bufp->fullIData(oldp+203,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[7]),32);
    bufp->fullIData(oldp+204,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[8]),32);
    bufp->fullIData(oldp+205,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[9]),32);
    bufp->fullIData(oldp+206,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[10]),32);
    bufp->fullIData(oldp+207,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[11]),32);
    bufp->fullIData(oldp+208,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[12]),32);
    bufp->fullIData(oldp+209,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[13]),32);
    bufp->fullIData(oldp+210,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[14]),32);
    bufp->fullIData(oldp+211,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[15]),32);
    bufp->fullIData(oldp+212,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[16]),32);
    bufp->fullIData(oldp+213,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[17]),32);
    bufp->fullIData(oldp+214,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[18]),32);
    bufp->fullIData(oldp+215,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[19]),32);
    bufp->fullIData(oldp+216,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[20]),32);
    bufp->fullIData(oldp+217,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[21]),32);
    bufp->fullIData(oldp+218,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[22]),32);
    bufp->fullIData(oldp+219,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[23]),32);
    bufp->fullIData(oldp+220,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[24]),32);
    bufp->fullIData(oldp+221,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[25]),32);
    bufp->fullIData(oldp+222,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[26]),32);
    bufp->fullIData(oldp+223,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[27]),32);
    bufp->fullIData(oldp+224,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[28]),32);
    bufp->fullIData(oldp+225,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[29]),32);
    bufp->fullIData(oldp+226,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[30]),32);
    bufp->fullIData(oldp+227,(vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_GPR__DOT__reg_file[31]),32);
    bufp->fullBit(oldp+228,(vlSelf->clk));
    bufp->fullBit(oldp+229,(vlSelf->rst));
    bufp->fullIData(oldp+230,(vlSelf->inst),32);
    bufp->fullIData(oldp+231,(vlSelf->pc),32);
    bufp->fullCData(oldp+232,((0x7fU & vlSelf->inst)),7);
    ...
    __Vtemp_h8360e938__0[8U] = (0xcc00U | (vlSelf->ysyx_23060201_TOP__DOT__wire_rdata1 
                                           >> 0x16U));
    bufp->fullWData(oldp+237,(__Vtemp_h8360e938__0),273);
    ...
    __Vtemp_habfd3ff5__0[2U] = (0x3780U | ((vlSelf->pc 
                                            + vlSelf->ysyx_23060201_TOP__DOT__wire_imm) 
                                           >> 0x19U));
    bufp->fullWData(oldp+246,(__Vtemp_habfd3ff5__0),78);
    bufp->fullSData(oldp+249,((0x460U | (0x1fU & ((vlSelf->inst 
                                                   >> 0xfU) 
    ...
    __Vtemp_h5f3ef283__0[9U] = (0x260000U | (vlSelf->ysyx_23060201_TOP__DOT__ysyx_23060201_IDU__DOT__imm_I 
                                             >> 0xfU));
    bufp->fullWData(oldp+254,(__Vtemp_h5f3ef283__0),312);
