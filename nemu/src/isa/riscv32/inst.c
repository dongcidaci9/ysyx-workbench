...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT_START();
	...
	INSTPAT("000000? ????? ????? 001 ????? 00100 11", addi   , I, R(rd) = (src1 << BITS(imm, 6, 0)));
  ...
  INSTPAT("0000000 00001 00000 000 00000 11100 11", ebreak , N, NEMUTRAP(s->pc, R(0))); // R(10) is $a0 // Return 0
